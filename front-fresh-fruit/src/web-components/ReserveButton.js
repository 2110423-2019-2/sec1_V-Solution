        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <form class="form-inline xl-form mr-auto mb-8">
                    ...
                    <p id='amount' style={{ color: '#6AC17D' }}>we have {props.amount} in our stock</p>
                    ...
                    <button class="dropdown-item" id="reserve-button" type="button" class='btn btn-primary' onClick={submitReserve}>Purchase</button>
                </form>
            </div>
        </div>
    );
